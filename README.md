# 🔶 Anotaciones utiles sobre Java
Este repositorio contiene anotaciones y ejemplos de código sobre conceptos fundamentales de Java.

## 📙 Temas
1. **Tipos de datos**: [Anotaciones](Anotaciones/00-Tipos-de-Datos.md) | [Codigo](Basics/src/tipos_de_datos)
2. **Estructuras de datos**: [Anotaciones](Anotaciones/01-Estructuras-de-Datos.md) | [Codigo](Basics/src/estructuras_de_datos/EstructurasDeDatos.java)
3. **Funciones y control de flujo**: [Anotaciones](Anotaciones/02-Control-de-Flujo-y-Funciones.md) | [Codigo](Basics/src/funciones_y_control_de_flujo)
4. **POO**: [Anotaciones](Anotaciones/03-POO.md) | [Codigo](Basics/src/poo)
